  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6">
      ...
      <p className="mt-4 max-w-2xl text-lg text-stone-600">
        Pay once per gift order at checkout. No subscription required — send cookies when
        you need them.
      </p>
      ...
      <div className="mt-12 rounded-3xl border border-stone-200/90 bg-white/90 p-8 shadow-sm">
        ...
        <p className="mt-2 text-sm text-stone-500">
          Choose how many cookies to send; you pay that amount once via Stripe when you
          submit the order.
        </p>
